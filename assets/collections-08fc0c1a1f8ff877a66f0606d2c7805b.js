...
define('collections/adapters/collection', ['exports', 'ember', 'ember-data', 'config/environment'], function (exports, _ember, _emberData, _environment) {
    'use strict';
    ...
    exports.default = JSONAPIAdapter.extend({
        ...
        host: _environment.default.osfHostUrl,
        namespace: 'api',
...
define('collections/adapters/node', ['exports', 'ember', 'ember-data', 'collections/config/environment'], function (exports, _ember, _emberData, _environment) {
    'use strict';
...
define('collections/adapters/preprint', ['exports', 'collections/adapters/node'], function (exports, _node) {
  'use strict';
...
define('collections/adapters/registration', ['exports', 'collections/adapters/node'], function (exports, _node) {
  'use strict';
...
define('collections/adapters/workflow', ['exports', 'ember-data'], function (exports, _emberData) {
    'use strict';
            ...
            return new _ember.default.RSVP.Promise(function (resolve, reject) {
                _this.getUserInfo().then(function (response) {
                    ...
                    if (!response || !response.token) {
                        if (redirectToLogin) {
                            window.location = _environment.default.apiBaseUrl + '/accounts/osf/login/?' + _ember.default.$.param({ next: 'http://localhost:4200/' });
...
define('collections/components/meeting-submit/component', ['exports', 'ember'], function (exports, _ember) {
    'use strict';
...
define('collections/components/navbar-auth-dropdown/component', ['exports', 'ember', 'ember-osf/components/navbar-auth-dropdown/component'], function (exports, _ember, _component) {
    'use strict';
...
if (!runningTests) {
  require("collections/app")["default"].create({"usingCors":true,"corsWithCreds":true,"apiURL":"https://osf-collections.herokuapp.com","name":"collections","version":"0.0.0+e3dde17b"});
}
