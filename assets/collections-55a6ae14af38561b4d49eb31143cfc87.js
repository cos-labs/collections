...
define('collections/adapters/workflow', ['exports', 'ember-data', 'collections/config/environment'], function (exports, _emberData, _environment) {
    ...
    exports.default = RESTAdapter.extend({
        ...
        buildURL: function buildURL() {
            var base = this._super.apply(this, arguments);
            return _environment.default.apiBaseUrl + '/data' + base + '.json';
        }
    });
});
...
if (!runningTests) {
  require("collections/app")["default"].create({"usingCors":true,"corsWithCreds":true,"apiURL":"https://dev-labs-2.cos.io/api","name":"collections","version":"0.0.0+1ac17eaa"});
}
