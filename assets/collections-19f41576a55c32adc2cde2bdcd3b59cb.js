...
define('collections/adapters/parameter-alias', ['exports', 'ember-data', 'collections/config/environment'], function (exports, _emberData, _environment) {
    ...
    exports.default = JSONAPIAdapter.extend({
        ...
        buildURL: function buildURL(type, id, snapshot, requestType, query) {
            ...
            var caxe = this.get('caxe.activeCase.id');
            if (caxe) {
                url.push('/cases/' + caxe);
            }
            url.push(base);
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 3:
                                ...
                                _this.get('widget.parameters.choices.value').map(function () {
...
define("collections/components/choice-picker/template", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "cBfHsEZT", "block": "{\"statements\":[[1,[28,[\"widget\",\"description\"]],false],[0,\"\\n\"],[6,[\"each\"],[[28,[\"widget\",\"parameters\",\"choices\",\"value\"]]],null,{\"statements\":[[0,\"    \"],[11,\"div\",[]],[13],[0,\"\\n        \"],[1,[33,[\"radio-button\"],null,[[\"value\",\"checked\"],[[28,[\"choice\",\"parameter\"]],[28,[\"chosen\"]]]]],false],[1,[28,[\"choice\",\"label\"]],false],[0,\"\\n    \"],[14],[0,\"\\n\"]],\"locals\":[\"choice\"]},null]],\"locals\":[],\"named\":[],\"yields\":[],\"hasPartials\":false}", "meta": { "moduleName": "collections/components/choice-picker/template.hbs" } });
});
...
define('collections/components/collection-nav/component', ['exports'], function (exports) {
    'use strict';
...
define("collections/components/datetime-field/template", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "JG/EykIv", "block": "{\"statements\":[[11,\"style\",[]],[13],[0,\"\\n\\n    .submission-text-field {\\n        margin-top: 10px;\\n    }\\n\\n\\n\"],[14],[0,\"\\n\\n\"],[6,[\"if\"],[[33,[\"not\"],[[28,[\"editing\"]]],null]],null,{\"statements\":[[0,\"\\n    \"],[1,[26,[\"valueName\"]],false],[0,\": \"],[1,[28,[\"widget\",\"parameters\",\"date\",\"value\"]],false],[0,\"\\n\\n\"]],\"locals\":[]},null],[0,\"\\n\"],[6,[\"if\"],[[28,[\"editing\"]]],null,{\"statements\":[[0,\"    \"],[11,\"div\",[]],[15,\"class\",\"submission-text-field\"],[13],[0,\"\\n        \"],[11,\"label\",[]],[13],[1,[28,[\"widget\",\"description\"]],false],[14],[0,\"\\n        \"],[1,[33,[\"bs-datetimepicker\"],null,[[\"date\"],[[28,[\"dtFieldValue\"]]]]],false],[0,\"\\n    \"],[14],[0,\"\\n\"]],\"locals\":[]},null],[18,\"default\"],[0,\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[\"default\"],\"hasPartials\":false}", "meta": { "moduleName": "collections/components/datetime-field/template.hbs" } });
});
define('collections/components/datetime-picker/component', ['exports'], function (exports) {
    ...
    exports.default = Ember.Component.extend({
        ...
        //datePickerValueObserver: Ember.observer('pickerValue', function() {
        //this.set('widget.parameters.date.value', this.get('pickerValue'));
        //this.get('widget.parameters.date').save();
        //}),

        //didRecieveAttrs() {
        //debugger;
        //this.set('pickerValue_', this.get('widget.parameters.date.value'));
        //}
...
define('collections/components/group-detail/component', ['exports'], function (exports) {
    'use strict';
...
define('collections/components/item-detail-page/component', ['exports', 'collections/utils/itemClasses'], function (exports, _itemClasses) {
    'use strict';
...
define('collections/components/meeting-keynote-speakers/component', ['exports', 'lodash'], function (exports, _lodash) {
    'use strict';
...
define('collections/components/node-creator/component', ['exports'], function (exports) {
    ...
    exports.default = Ember.Component.extend({
        ...
        createNodeObserver: Ember.observer('create', function () {
            ...
            Ember.run(function () {
                var create = _this.get('widget.parameters.create.value');
                if (create === true) {
                    _this.get('node').save();
                    _this.set('widget.parameters.node.value', _this.get('node'));
                }
            });
        }),
...
define("collections/components/node-creator/template", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "0qMkT8mC", "block": "{\"statements\":[],\"locals\":[],\"named\":[],\"yields\":[],\"hasPartials\":false}", "meta": { "moduleName": "collections/components/node-creator/template.hbs" } });
});
...
define('collections/components/text-field/component', ['exports'], function (exports) {
    ...
    exports.default = Ember.Component.extend({
        ...
        textFieldValueObserver: Ember.observer('textFieldValue', function () {
            var currentComponentValue = this.get('textFieldValue');
            var currentParameterValue = this.get('widget.parameters.value.value');
...
define('collections/controllers/collection', ['exports'], function (exports) {
    'use strict';
...
define('collections/controllers/collection/add', ['exports', 'collections/config/environment'], function (exports, _environment) {
    'use strict';
    ...
    exports.default = Ember.Controller.extend({
        ...
        updateState: function updateState(actions) {
            ...
            actions.forEach(function (action) {
                ...
                var fireActions = function () {
                    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(actionId) {
        ...
        createWidget: function createWidget(widgetComponent, description, disabled, cssClasses, section, outputParameter, actionId, parameters) {
            var fireActions = function () {
                var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(actionId) {
                    var actionObj, result;
                    return regeneratorRuntime.wrap(function _callee2$(_context2) {
                        while (1) {
                            switch (_context2.prev = _context2.next) {
        ...
        uploadFile: function () {
            var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(fileName, fileData, node) {
...
define('collections/controllers/collection/browse', ['exports'], function (exports) {
    'use strict';
...
define('collections/controllers/collection/edit', ['exports'], function (exports) {
    'use strict';
...
define('collections/controllers/collection/group', ['exports'], function (exports) {
    'use strict';
...
define('collections/controllers/collection/group/index', ['exports'], function (exports) {
    'use strict';
...
define('collections/controllers/collection/group/item', ['exports'], function (exports) {
    'use strict';
...
define('collections/controllers/collection/index', ['exports'], function (exports) {
    'use strict';
...
define('collections/controllers/collection/item', ['exports'], function (exports) {
  'use strict';
...
define('collections/controllers/collection/search', ['exports'], function (exports) {
    'use strict';
...
define('collections/controllers/index', ['exports'], function (exports) {
    'use strict';
    ...
    exports.default = Model.extend({
        ...
        parameters: Ember.computed('parameterAliases.@each.parameter', {
            get: function get() {
                ...
                this.get('parameterAliases').then(function (aliases) {
                    var promises = aliases.reduce(function (parameters, alias) {
                        var deferred = Ember.RSVP.defer(alias.get('alias'));
                        alias.get('parameter').then(function (parameter) {
                            deferred.resolve(parameter);
                        });
                        parameters[alias.get('alias')] = deferred.promise;
                        return parameters;
                    }, {});
                    Ember.RSVP.hash(promises).then(function (resolved) {
                        _this.set('parameters', resolved);
                    });
                });
...
define('collections/routes/collection', ['exports'], function (exports) {
    'use strict';
...
define('collections/routes/collection/add', ['exports'], function (exports) {
    'use strict';
    ...
    exports.default = Ember.Route.extend({
        ...
        model: function model() {
            ...
            var collectionType = this.modelFor('collection').get('collectionType');
            var submissionFormId = {
                'meeting': 1
            }[collectionType];
            var caxe = this.store.createRecord('case');
            return this.store.findRecord('workflow', submissionFormId).then(function (workflow) {
                ...
                return Ember.RSVP.hash({
                    workflow: _this.store.findRecord('workflow', submissionFormId),
                    collection: _this.modelFor('collection')
                });
            });
        },
...
define('collections/routes/collection/browse', ['exports'], function (exports) {
  'use strict';
...
define('collections/routes/collection/edit', ['exports'], function (exports) {
  'use strict';
...
define('collections/routes/collection/group', ['exports'], function (exports) {
    'use strict';
...
define('collections/routes/collection/group/index', ['exports'], function (exports) {
  'use strict';
...
define('collections/routes/collection/group/item', ['exports'], function (exports) {
    'use strict';
...
define('collections/routes/collection/index', ['exports'], function (exports) {
  'use strict';
...
define('collections/routes/collection/item', ['exports'], function (exports) {
    'use strict';
...
define('collections/routes/collection/search', ['exports'], function (exports) {
  'use strict';
...
define('collections/utils/itemClasses', ['exports', 'ember-get-config', 'ember-osf/utils/load-relationship'], function (exports, _emberGetConfig, _loadRelationship) {
    'use strict';
     ...
     */
    var ViewData = Ember.Object.extend({
        value: null,
        loaded: false,
        visible: true,
    ...
    var Presentation = Item.extend({
        setPreprint: function setPreprint() {
            ...
            node.get('preprints').then(function (result) {
                if (result.objectAt(0)) {
                    result.objectAt(0).get('primaryFile').then(function (pf) {
                        _this6.get('viewContent.file').setValue(pf.get('links').download);
                    });
                }
            });
        },
        init: function init() {
            ...
            this._super();
            this.get('store').findRecord('node', this.get('item.source_id')).then(function (node) {
                _this7.setCommonNodeContent(node);
                _this7.setPreprint();
            });
        }
    });
    ...
    var Registration = Item.extend({
        init: function init() {
            ...
            this.get('store').findRecord('registration', this.get('item.source_id')).then(function (node) {
                _this8.setCommonNodeContent(node);
            });
        }
    });
...
if (!runningTests) {
  require("collections/app")["default"].create({"usingCors":true,"corsWithCreds":true,"apiURL":"https://dev-labs-2.cos.io/api","name":"collections","version":"0.0.0+4ea27b27"});
}
