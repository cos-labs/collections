...
define('collections/routes/collections/collection/item', ['exports'], function (exports) {
    ...
    exports.default = Ember.Route.extend({
        ...
        afterModel: function afterModel(model, transition) {
            ...
            this.set('crumb.route', this.routeName);
            this.set('crumb.models', [this.get('collection'), this.get('item')]);
...
if (!runningTests) {
  require("collections/app")["default"].create({"usingCors":true,"corsWithCreds":true,"apiURL":"https://dev-labs-2.cos.io/api","name":"collections","version":"0.0.0+f8acb1cd"});
}
